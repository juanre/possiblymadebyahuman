...
- The producer that created the record declared a specific set of capabilities (e.g. timing, source attribution). Analyzers honestly report when a capability is missing instead of penalising the record for it.
