...
- **Text leaking into public storage.** Producers do not upload text; the ingest API rejects content-bearing fields on public submissions; the record app renders structure only.
